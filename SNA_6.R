...
bu3<-remDr$findElement(using='css',value='body > div.RnEpo._Yhr4 > div.pbNvD.QZZGH.bW6vo > div > article > div > div.HP0qD > div > div > div.eo2As > div.EtaWk > ul > ul:nth-child(3) > li > ul > li > div > button > span')
bu3$clickElement()
